...
public class AtlasStructure {
    ...
    private static String[] attributeNames = new String[]{
            "id", "depth", "acronym",
            "name", "structure-id-path", "color-hex-triplet"};
     ...
     */
    public AtlasStructure(String id, String depth, String acronym,
                          String name, String path, String color, boolean active) {
        setId(id);
        setDepth(depth);
        setAcronym(acronym);
        setName(name);
